...
router.post('/', function(req, res){
         ...
         console.log('log is connecting....log is connecting....log is connecting');
        ...
        computed value*/
         ...
         connection.query(sql, ['Log', personalEmail], function (error, results, fields) {
            console.log('its the object');
             if(error) throw error;  
                 ...
                 if((gettingLength == 0)){
                      ...
                      res.send({'message': 'you have no people log!!'});
                 }
          });
});
