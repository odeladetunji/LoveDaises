...
router.post('/', function(req, res){
  // getting html form input
    ...
    console.log('the Data above was from settingsBeloved Form');
    ...
    console.log(email + "   settingsBeloved.js");
...
function sendingMessageBackToSettings(){
     res.send({'message': 'Beloved Daises was submitted succesfully'});
     console.log('Beloved Daises Was inputed successfully');
}
