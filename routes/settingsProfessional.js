...
router.post('/', function(req, res){
  // getting html form input
    ...
    console.log('the Data above was from settingsProfessional Form');
    ...
    console.log(email + "   settingsProfessional.js");
...
function sendingMessageBackToSettings(){
     res.send({'message': 'Professional Daises was submitted succesfully'});
     console.log('professional Daises Was inputed successfully');
}
