...
router.post('/', function(req, res){
         ...
         console.log('this is an Ajax Call to Sharing........................');
        ...
        computed value*/
         ...
         connection.query(sql, ['Sharing', personalEmail], function (error, results, fields) {
            console.log('its the object');
             if(error) throw error;  
                 ...
                 if((gettingLength == 0)){
                      ...
                      res.send({'message': 'No People to Share to'});
                 }
          });
});
