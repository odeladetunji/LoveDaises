...
router.post('/', function(req, res){
         ...
         console.log('Group is connecting....log is connecting....Group is connecting');
        ...
        computed value*/
         ...
         connection.query(sql, ['Group', personalEmail], function (error, results, fields) {
            console.log('its the object');
             if(error) throw error;  
                 ...
                 if((gettingLength == 0)){
                      ...
                      res.send({'message': 'You do not belog to any group!!'});
                 }
          });
});
